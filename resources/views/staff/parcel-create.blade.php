...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('staff.show', $user) }}">View Staff</a></li>
	<li class="breadcrumb-item active" aria-current="page">Add Parcel</li>
@endpush

@section('content')
    <main class="content">
        <form method="POST" action="{{ route('staff.parcel.store', $user) }}">
        @csrf
                                ...
                                <div class="border rounded">
                                    <div class="row m-2">
                                        <div class="col-md-4">
                                            ...
                                            <h6 class="card-subtitle text-muted">Add parcel for staff to pickup.</h6>
                                        </div>
                                        <div class="col-md-6">
